<template>
  <div class="page-card">
    <div class="table-toolbar">
      ...
      <el-button type="primary" @click="dialogVisible = true">提交报工</el-button>
    </div>

    <el-table :data="list" v-loading="loading" border>
      <el-table-column prop="id" label="记录号" width="80" />
      <el-table-column prop="dispatchId" label="派工单ID" width="100" />
      <el-table-column prop="operatorId" label="报工人ID" width="100" />
      ...
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="不良原因">
          <el-select v-model="form.scrapReason" placeholder="选择不良原因" style="width: 100%">
            <el-option label="尺寸超差" value="1" />
            <el-option label="外观缺陷" value="2" />
            <el-option label="功能异常" value="3" />
            <el-option label="材料缺陷" value="4" />
            <el-option label="操作失误" value="5" />
          </el-select>
        </el-form-item>
...
import { getReportList, submitReport } from '../../api/order'
